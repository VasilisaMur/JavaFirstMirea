...
class VictorianChair extends ChairClient implements Test{
    @Override
...
class MultifunctionalChair extends ChairClient implements Test{
    @Override
    public void Description() {
        System.out.println("Вы сидите на многофункциональном стуле");
    }
}
class MagicChair extends ChairClient implements Test{
    @Override
    public void Description() {
